...
@section('content')
    ...
    <ul class="nav nav-tabs mb-3" id="dashTab" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link active" id="calendar-tab" data-bs-toggle="tab" data-bs-target="#calendar-pane"
                type="button">Rostering Calendar</button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="invoice-tab" data-bs-toggle="tab" data-bs-target="#invoice-pane"
                type="button">Recent Invoices</button>
        </li>
    </ul>
                    ...
                    <tbody>
                        @forelse($invoices as $inv)
                            <tr>
                                ...
                                <td>
                                    <span
                                        class="badge bg-{{ $inv->status === 'published' ? 'success' : 'secondary' }}">{{ ucfirst($inv->status) }}</span>
                                </td>
